...
export default function Announcements({ data }: SlideProps) {
  ...
  return (
    ...
    >
      ...
      <h1
        {...$.title({ marginBottom: $.s4, fontSize: "2.5em", color: "white", fontWeight: 500 })}
      >
        Spread the word! You and your projects made{" "}
        <strong
          style={{
